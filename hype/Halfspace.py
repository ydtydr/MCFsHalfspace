...
#             newp_val[...,-1] = th.div(p_val[...,-1], coshs-d_val[...,-1]*sihncs)#n
            ...
            if len(Pos) !=0:
                ...
                newp_val[..., :-1][mask_pos] = p_val[..., :-1][mask_pos] + (th.div(scoths + Pos[..., -1],
                                                              scschs_square + r_square) * p_val[...,-1][mask_pos]).unsqueeze(-1) * Pos[...,:-1]
                newp_val[..., -1][mask_pos] = th.div(s_postive + Pos[..., -1] * th.tanh(s_postive),
                                                     r_square + th.pow(th.div(Pos[..., -1], th.cosh(s_postive)) ,2)) * th.div(s_postive, th.cosh(s_postive)) * p_val[...,-1][mask_pos]
            if len(Neg) !=0:
                ...
                sihncs[zeros_mask] = th.ones_like(sihncs[th.isnan(sihncs)])
                newp_val[...,:-1][mask_neg] = p_val[...,:-1][mask_neg] + th.div(p_val[...,-1][mask_neg], th.div(coshs, sihncs)-Neg[...,-1]).unsqueeze(-1) * Neg[...,:-1]#n*(d-1)
...
class HalfspaceDistance(Function):
    ...
    def forward(self, u, v, myeps = 0.0):
        ...
        sqnorm = th.sum(th.pow(u - v, 2), dim=-1)
    ...
    def backward(self, g):
        ...
        auxli_term = th.div(u - v, (u[...,-1] * v[...,-1]).unsqueeze(-1).expand_as(u))#m*n*d
        gu[..., :-1] = th.div(1, self.z_).unsqueeze(-1) * auxli_term[...,:d-1]#m*n*(d-1)
        gu[..., -1] = th.div(1, self.z_) * (auxli_term[...,-1] - th.div(self.x_, u[...,-1]))#m*n
        gv[..., :-1] = -1 * gu[..., :-1]  # m*n*(d-1)
